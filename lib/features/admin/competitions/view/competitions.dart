...
import '../../competition/view/view.dart';
import '../../drawer/view/drawer.dart';


class AdminCompetitionPage extends StatefulWidget {
  const AdminCompetitionPage({super.key});

  @override
  State<AdminCompetitionPage> createState() => _AdminCompetitionPageState();
}

class _AdminCompetitionPageState extends State<AdminCompetitionPage> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () => {
          Navigator.push(context, MaterialPageRoute(builder: (context) => AdminCompetitionCreate())),
        },

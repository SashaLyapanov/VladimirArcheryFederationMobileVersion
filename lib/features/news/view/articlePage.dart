...
class ArticlePage extends StatefulWidget {
  ...
  const ArticlePage({super.key, required this.articleId, required this.article});

  @override
  State<ArticlePage> createState() => _ArticlePage(articleId, article!);
}
...
class _ArticlePage extends State<ArticlePage> {
  ...
  _ArticlePage(this.articleId, this.article);
                              ...
                              child: Align(
                                ...
                                child: SizedBox(
                                  ...
                                  child: InkWell(
                                      ...
                                      child: const Image(
                                        image: AssetImage('assets/images/backArrow/backArrow4.png'),)
                                  ),
                                ),
                              ),
                            ),
